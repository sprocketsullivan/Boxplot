...
skills: 1
```
The `ggplot2` library offers excellent plotting capabilities that allow for a wide range of customisation. The function [`aes()`](https://www.rdocumentation.org/packages/ggplot2/versions/2.2.1/topics/aes), e.g, describes how  data are mapped to visual properties (aesthetics) of geometric objects (geoms).
